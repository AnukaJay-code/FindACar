...
public class JeepDataActivity extends AppCompatActivity {


    private static final String Tag = "JeepDataActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jeep_list);
    ...
    private void populateListView() {
        ...
        Cursor data = mDBHandler.getJeepData();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Cursor data1 = mDBHandler.getJeepData();
                ...
                Intent editScreenIntent = new Intent(JeepDataActivity.this,EditDataActivity.class);
